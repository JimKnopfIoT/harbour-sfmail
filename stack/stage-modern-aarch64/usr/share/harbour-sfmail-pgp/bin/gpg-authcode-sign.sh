...
#AUTHENTICODE_KEY=<generated>/my-authenticode-key.p12
#AUTHENTICODE_CERTS=<generated>/my-authenticode-certs.pem
...
AUTHENTICODE_CERTS=<generated>/my_authenticode_cert.pem
