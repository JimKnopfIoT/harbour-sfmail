...
If it bothers you, take the other entry out of that lookup from a root shell. This is cosmetic, changes nothing about how mail works, and a system update restores the file anyway:</source>
        <translation>Bij het tikken op een melding ziet u mogelijk de tegel van het andere e-mailprogramma even oplichten. Daar start niets: het startscherm tekent een plaatshouder voor degene die de e-maildienst opeist, het bericht zelf gaat hier open, en de lege plaatshouder verdwijnt weer. Deze app wordt er niet door beïnvloed.

Als het stoort, haalt u het andere item in een root-shell uit die toewijzing. Dit is puur cosmetisch, verandert niets aan de werking van e-mail, en een systeemupdate zet het bestand toch terug:</translation>
    </message>
    <message>
        <source>Undo it at any time with the same command reversed:</source>
        <translation>Op elk moment ongedaan te maken met hetzelfde commando omgekeerd:</translation>
    </message>
    <message>
